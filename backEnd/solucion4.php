...
<head>
    ...
    <title>Solucion 4</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.6/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-4Q6Gf2aSP4eDXB8Miphtr37CMZZQ5oXLH2yaXMJ2w8e2ZtHTl7GptT4jmndRuHDT" crossorigin="anonymous">
</head>
<body>
    <div class="container mt-4">
        <?php
        require_once('data/operacion4.php');
        ...
        if ($_POST && isset($_POST['txt_num1'], $_POST['txt_num2'], $_POST['txt_num3'])) {
            ...
            $mayor_menor = new Mayor_menor($num1, $num2, $num3);
            $resultado = $mayor_menor->getMayor() . ', ' . $mayor_menor->getMenor();
        }
        ?>
        
        <form method="POST">
            <h3>
                Determinar el mayor , menor de los 3 numeros
            </h3>
        ...
        <?php if ($resultado !== null): ?>
            <div class="alert alert-success mt-4" role="alert">
                ...
                <p class="mb-0">El orden de los numeros de mayor a menor es: <strong><?php echo $resultado; ?></strong></p>
            </div>
        <?php endif; ?>
    </div>
