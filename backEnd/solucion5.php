...
<head>
    ...
    <title>Solucion 5</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.6/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-4Q6Gf2aSP4eDXB8Miphtr37CMZZQ5oXLH2yaXMJ2w8e2ZtHTl7GptT4jmndRuHDT" crossorigin="anonymous">
</head>
<body>
    <div class="container mt-4">
        <?php
        require_once('data/operacion5.php');
        ...
        if ($_POST && isset($_POST['txt_num1'], $_POST['txt_num2'])) {
            ...
            $potencia = new Potencia($num1, $num2);
            $resultado = $potencia->getResultado();
        }
        ?>
        
        <form method="POST">
            <h3>
                Calcular un numero elevado a una potencia
            </h3>
            ...
            <div class="mb-3">
                <label for="txt_num2" class="form-label">Ingrese la potencia</label>
        ...
        <?php if ($resultado !== null): ?>
            <div class="alert alert-success mt-4" role="alert">
                ...
                <p class="mb-0">El numero elevado a la potencia ingresada es: <strong><?php echo number_format($resultado, 2); ?></strong></p>
            </div>
        <?php endif; ?>
    </div>
