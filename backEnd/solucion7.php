...
<body>
    <div class="container mt-4">
        <?php
        require_once('data/operacion7.php');
        ...
        if ($_POST && isset($_POST['txt_num1'])) {
            ...
            $factorial = new Factorial($num1);
            $resultado = $factorial->getResultado();
        }
        ?>
        ...
        <?php if ($resultado !== null): ?>
            <div class="alert alert-success mt-4" role="alert">
                ...
                <p class="mb-0">El factorial del numero es: <strong><?php echo $resultado; ?></strong></p>
            </div>
        <?php endif; ?>
    </div>
